              ...
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
                  ...
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.875rem", color: "var(--muted-foreground)", fontWeight: 300 }}>
                    Keep track of exquisite designs you love by tapping the heart icon
                  </p>
                  <button
                    onClick={onClose}
                    ...
                    <div key={item.id} className="flex gap-4 p-3 rounded-2xl" style={{ background: "#13100A", border: "1px solid rgba(201,168,76,0.15)" }}>
                      ...
                      <div className="flex-1 flex flex-col gap-1">
                        ...
                        <div className="flex items-center justify-between mt-auto">
                          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "0.95rem", fontWeight: 700, color: "var(--rose-gold)" }}>
                          ...
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="p-2 rounded-full border border-[#C9A84C]/35 hover:bg-[#C9A84C]/15 transition-colors"
                              title="Add to bag"
                            >
                              <ShoppingBag size={12} className="text-[#C9A84C]" />
                            </button>
                            <button
                              ...
                              title="Remove item"
                            >
                              <Trash2 size={12} style={{ color: "#d4183d" }} />
                            </button>
                          </div>
                        </div>
                      </div>
